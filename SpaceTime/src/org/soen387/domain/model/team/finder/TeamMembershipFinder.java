package org.soen387.domain.model.team.finder;
...
public class TeamMembershipFinder {
	public static final String FIND_BY_PILOT = "SELECT "
			+ TeamMembershipTDG.COLUMNS + " FROM "
			+ TeamMembershipTDG.TABLE_NAME + " WHERE pilot=?;";
	...
	public static final String FIND_BY_TEAM = "SELECT " + PilotTDG.COLUMNS
			+ " FROM " + TeamMembershipTDG.TABLE_NAME + " INNER JOIN "
			+ PilotTDG.TABLE_NAME + " ON id=pilot WHERE team=?;";
