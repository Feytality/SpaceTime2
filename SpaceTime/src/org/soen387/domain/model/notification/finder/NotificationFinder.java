package org.soen387.domain.model.notification.finder;
...
public class NotificationFinder {
	...
	public static final String FIND_BY_RECIPIENT = "SELECT "
			+ ChallengeNotificationTDG.COLUMNS + " FROM " + ChallengeNotificationTDG.TABLE_NAME
			+ " WHERE recipient=?;";
	...
	public static final String FIND_ALL = "SELECT " + ChallengeNotificationTDG.COLUMNS
			+ " FROM " + ChallengeNotificationTDG.TABLE_NAME + ";";
