...
public class NotificationFactory {
	...
	public static Notification createNew(IPlayer recipient, boolean seen)
			throws SQLException, MissingMappingException, MapperException {
		Notification result = new Notification(ChallengeNotificationTDG.getMaxId(), 01,
				recipient, seen);
	...
	public static Notification createClean(long id, long version,
			IPlayer recipient, boolean seen) throws SQLException,
