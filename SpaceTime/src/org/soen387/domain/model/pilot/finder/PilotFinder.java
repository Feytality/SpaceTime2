package org.soen387.domain.model.pilot.finder;
...
public class PilotFinder {
	...
	public static final String FIND_BY_USER = "SELECT " + PilotTDG.COLUMNS + " FROM " + PilotTDG.TABLE_NAME + " WHERE player=?;";
	public static ResultSet findByUser(long player) throws SQLException {
    	Connection con = DbRegistry.getDbConnection();
